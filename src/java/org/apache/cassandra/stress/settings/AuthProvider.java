...
import org.apache.cassandra.stress.util.JavaDriverV4Config;
import org.apache.cassandra.stress.util.JavaDriverV4Session;
...
public class AuthProvider {
  ...
  public com.datastax.driver.core.AuthProvider ToV3() {
  ...
  public JavaDriverV4Session ToV4() {
    if (authClassName == null || authClassName.isEmpty()) {
      return null;
    }
    if (authClassName.equals("com.datastax.oss.driver.internal.core.auth.PlainTextAuthProvider") ||
      ...
      return new JavaDriverV4Session() {
        @Override
