...
public class TableMetadata {
  ...
  public TableMetadata(shaded.com.datastax.oss.driver.api.core.metadata.schema.TableMetadata metadata) {
    this.metadata = metadata;
  }
  ...
  public shaded.com.datastax.oss.driver.api.core.metadata.schema.TableMetadata ToV4Value() {
    return (shaded.com.datastax.oss.driver.api.core.metadata.schema.TableMetadata) metadata;
  }
  ...
  public List<String> getColumnNames() {
    ...
    return ToV4Value().getColumns().keySet().stream().map(shaded.com.datastax.oss.driver.api.core.CqlIdentifier::toString).collect(Collectors.toList());
  }
