...
import com.scylladb.protocol.ProtocolVersion;
...
public class MapSerializer<K, V> extends CollectionSerializer<Map<K, V>>
{
    ...
    public static synchronized <K, V> MapSerializer getInstance(TypeSerializer<K> keys, TypeSerializer<V> values, Comparator<ByteBuffer> comparator)
    {
