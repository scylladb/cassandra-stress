...
import com.scylladb.stress.generate.FasterRandom;

public class Ascii extends Generator<String> {
    private final char[] chars;
    private final FasterRandom rnd = new FasterRandom();

    public Ascii(String name, GeneratorConfig config) {
        super(AsciiSerializer.instance, config, name, String.class);
