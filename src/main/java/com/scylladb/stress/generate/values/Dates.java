...
import com.scylladb.serializers.TimestampSerializer;
...
public class Dates extends Generator<Date> {
    public Dates(String name, GeneratorConfig config) {
        super(TimestampSerializer.instance, config, name, Date.class);
    }
    ...
    DistributionFactory defaultIdentityDistribution() {
        return OptionDistribution.get("uniform(1.." + 50L * 365L * 24L * 60L * 60L * 1000L + ")");
    }
}
