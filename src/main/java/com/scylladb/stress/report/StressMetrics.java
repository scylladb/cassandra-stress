package com.scylladb.stress.report;
/*
 *
...
import com.scylladb.stress.StressAction.Consumer;
import com.scylladb.stress.StressAction.MeasurementSink;
import com.scylladb.stress.StressAction.OpMeasurement;
import com.scylladb.stress.settings.SettingsLog.Level;
import com.scylladb.stress.settings.StressSettings;
import com.scylladb.stress.util.JmxCollector;
import com.scylladb.stress.util.ResultLogger;
import com.scylladb.stress.util.JmxCollector.GcStats;
import com.scylladb.stress.util.Uncertainty;
import com.scylladb.utils.Utils;
...
public class StressMetrics implements MeasurementSink {
    ...
    public void summarise() {
        ...
        output.println(String.format("Total GC memory           : %s", Utils.prettyPrintMemory((long) totalGcStats.bytes, true)));
