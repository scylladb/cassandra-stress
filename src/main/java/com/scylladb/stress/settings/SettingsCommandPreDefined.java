...
import com.scylladb.stress.generate.values.Bytes;
import com.scylladb.stress.generate.values.Generator;
import com.scylladb.stress.generate.values.GeneratorConfig;
import com.scylladb.stress.generate.values.HexBytes;
import com.scylladb.stress.operations.FixedOpDistribution;
import com.scylladb.stress.operations.OpDistribution;
import com.scylladb.stress.operations.OpDistributionFactory;
import com.scylladb.stress.operations.predefined.PredefinedOperation;
...
public class SettingsCommandPreDefined extends SettingsCommand
{
    ...
    public OpDistributionFactory getFactory(final StressSettings settings)
    {
        ...
        return new OpDistributionFactory()
        {
            ...
            {
                final Timer timer = new Timer(type.toString(), sink);
