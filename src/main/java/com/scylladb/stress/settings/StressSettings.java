...
public record StressSettings(SettingsCommand command, SettingsRate rate, SettingsPopulation generate,
                             SettingsInsert insert, SettingsColumn columns, SettingsErrors errors, SettingsLog log,
                             SettingsMode mode, SettingsNode node, SettingsSchema schema, SettingsTransport transport,
                             SettingsPort port, String sendToDaemon, SettingsGraph graph,
                             SettingsTokenRange tokenRange) implements Serializable {
        ...
        synchronized (this) {
            ...
            try {
                ...
                if (setKeyspace && schema.keyspace != null)
                    c.execute("USE \"" + schema.keyspace + "\";", com.scylladb.utils.ConsistencyLevel.ONE);
